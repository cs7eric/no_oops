...
function DockItem({
  ...
  return (
    <motion.div
      ...
      onClick={onClick}
      className={`relative inline-flex items-center justify-center rounded-2xl bg-[#060010] border-neutral-700 border-1 shadow-md ${className}`}
      tabIndex={0}
      role="button"
      aria-haspopup="true"
    >
  ...
  return (
    <motion.div style={{ height, scrollbarWidth: 'none' }} className="mx-2 flex max-w-full items-center">
      <motion.div
        ...
        className={`${className} absolute bottom-2 left-1/2 transform -translate-x-1/2 flex items-end w-fit gap-4 rounded-2xl border-neutral-700 border-1 pb-2 px-4`}
